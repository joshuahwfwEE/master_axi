...
#pragma HLS INTERFACE mode=m_axi bundle=bus max_read_burst_length=64 max_widen_bitwidth=32 num_read_outstanding=1 port=ps_to_romcode offset=slave

#pragma HLS INTERFACE mode=s_axilite bundle=control port=romcode_to_ps
#pragma HLS INTERFACE mode=m_axi bundle=bus max_widen_bitwidth=32 max_write_burst_length=64 num_write_outstanding=1 port=romcode_to_ps offset=slave
