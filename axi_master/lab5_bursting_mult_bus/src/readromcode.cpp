...
#pragma HLS INTERFACE mode=m_axi port=ps_to_romcode offset=slave max_read_burst_length=64 bundle=bus

#pragma HLS INTERFACE mode=s_axilite bundle=control port=romcode_to_ps
#pragma HLS INTERFACE mode=m_axi port=romcode_to_ps offset=slave max_write_burst_length=64 bundle=bus
