...
xilinx.com:hls:readromcode:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: readromcode_0, and set properties
  set readromcode_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:readromcode:1.0 readromcode_0 ]
...
\
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins readromcode_0/s_axi_control]
  connect_bd_intf_net -intf_net clk_300mhz_1 [get_bd_intf_ports clk_300mhz] [get_bd_intf_pins clk_wiz_0/CLK_IN1_D]
  connect_bd_intf_net -intf_net readromcode_0_internal_bram_PORTA [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTA] [get_bd_intf_pins readromcode_0/internal_bram_PORTA]
connect_bd_intf_net -intf_net [get_bd_intf_nets readromcode_0_internal_bram_PORTA] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTA] [get_bd_intf_pins system_ila_0/SLOT_0_BRAM]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets readromcode_0_internal_bram_PORTA]
  connect_bd_intf_net -intf_net readromcode_0_m_axi_bus_r [get_bd_intf_pins readromcode_0/m_axi_bus_r] [get_bd_intf_pins smartconnect_0/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets readromcode_0_m_axi_bus_r] [get_bd_intf_pins smartconnect_0/S00_AXI] [get_bd_intf_pins system_ila_1/SLOT_0_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets readromcode_0_m_axi_bus_r]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins rst_ps8_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins readromcode_0/ap_rst_n] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins system_ila_1/resetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins readromcode_0/ap_clk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins system_ila_1/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces readromcode_0/Data_m_axi_bus_r] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces readromcode_0/Data_m_axi_bus_r] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs readromcode_0/s_axi_control/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces readromcode_0/Data_m_axi_bus_r] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]
